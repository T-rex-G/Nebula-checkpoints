...
/*
 * Clearing an identity's exposure history. A new revision rather than an edit
 * to 1.3.0, for the same reason 1.3.0 was not an edit to 1.2.0: a stored
 * policy names the version and hash it was approved against.
 */
