...
- [Change B1: owner Git connections](docs/architecture/CHANGE_B_CONNECTIONS.md) — encrypted session credentials and read-only GitHub listing; owner creation/workbench/commits follow in B2
